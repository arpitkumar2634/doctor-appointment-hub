                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="appointmentTabsContent">
                        <div class="tab-pane fade show active" id="upcoming" role="tabpanel" aria-labelledby="upcoming-tab">
                            @if($appointments->where('appointment_date', '>=', today())->where('status', 'confirmed')->count() > 0)
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            @foreach($appointments->where('appointment_date', '>=', today())->where('status', 'confirmed') as $appointment)
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                ...
                                                                <small class="text-muted">
                                                                    @if($appointment->patientProfile->gender)
                                                                        {{ ucfirst($appointment->patientProfile->gender) }},
                                                                    @endif
                                                                    @if($appointment->patientProfile->date_of_birth)
                                                                        {{ \Carbon\Carbon::parse($appointment->patientProfile->date_of_birth)->age }} years
                                                                    @endif
                                                                </small>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        @if($appointment->patientProfile->medical_history)
                                                                            ...
                                                                            <p>{{ $appointment->patientProfile->medical_history }}</p>
                                                                        @endif
                                                                    </div>
                                                        ...
                                                        <div class="modal fade" id="completeModal{{ $appointment->id }}" tabindex="-1" aria-labelledby="completeModalLabel{{ $appointment->id }}" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="completeModalLabel{{ $appointment->id }}">Mark Appointment as Completed</h5>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        Are you sure you want to mark this appointment with {{ $appointment->patientProfile->user->name }} as completed?
                                                                    </div>
                                                                    <div class="modal-footer">
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    <p>You don't have any upcoming confirmed appointments.</p>
                                </div>
                            @endif
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#confirmModal{{ $appointment->id }}">
                                                                <i class="fas fa-check"></i>
                                                            </button>
                                                        ...
                                                        <!-- Confirm Modal -->
                                                        <div class="modal fade" id="confirmModal{{ $appointment->id }}" tabindex="-1" aria-labelledby="confirmModalLabel{{ $appointment->id }}" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="confirmModalLabel{{ $appointment->id }}">Confirm Appointment</h5>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        Are you sure you want to confirm this appointment with {{ $appointment->patientProfile->user->name }}?
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                                        <form action="{{ route('doctor.appointments.update-status', $appointment->id) }}" method="POST">
                                                        ...
                                                        <div class="modal fade" id="rejectModal{{ $appointment->id }}" tabindex="-1" aria-labelledby="rejectModalLabel{{ $appointment->id }}" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        Are you sure you want to reject this appointment with {{ $appointment->patientProfile->user->name }}?
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                                        <form action="{{ route('doctor.appointments.update-status', $appointment->id) }}" method="POST">
